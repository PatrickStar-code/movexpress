    ...
    <ol className="flex items-center w-full mb-4 sm:mb-5 justify-center">
      ...
      <li
        className={`flex w-full items-center ${
          step >= 1 ? "text-blue-600 dark:text-blue-500" : "text-gray-500"
      ...
      >
        ...
        >
          <svg
            className={`w-4 h-4 ${
              step >= 1 ? "text-blue-600 dark:text-blue-300" : "text-gray-500"
            } lg:w-6 lg:h-6`}
            aria-hidden="true"
      ...
      <li
        className={`flex w-full items-center ${
          step >= 2 ? "text-blue-600 dark:text-blue-500" : "text-gray-500"
        } after:content-[''] after:w-full after:h-1 after:border-b ${
          step >= 2
            ? "after:border-blue-100 dark:after:border-blue-800"
            : "after:border-gray-100 dark:after:border-gray-700"
      ...
      >
        ...
        >
          <svg
            className={`w-4 h-4 ${
              step >= 2 ? "text-blue-600 dark:text-blue-300" : "text-gray-500"
            } lg:w-6 lg:h-6`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
      ...
      >
        ...
        >
          <svg
            className={`w-4 h-4 ${
              step >= 3 ? "text-blue-600 dark:text-blue-300" : "text-gray-500"
            } lg:w-6 lg:h-6`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
